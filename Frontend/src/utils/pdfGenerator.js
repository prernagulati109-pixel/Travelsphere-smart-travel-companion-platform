...
export const pdfGenerator = {
  ...
  generateBookingPDF: (hotel, bookingData, totalPrice) => {
    ...
    doc.text(
      '• Please carry a valid Photo ID proof at the time of check-in.',
      15,
      finalY + 10
    );

    doc.text(
      '• Check-in time is usually 12:00 PM and Check-out is 11:00 AM.',
      15,
      finalY + 17
    );

    doc.text(
      '• For any queries, contact Travelsphere Support: +1-800-TRAVEL',
      15,
      finalY + 24
    );
